      ...
      <div className='container mx-auto px-4 py-4'>
        <div className='flex items-center justify-between'>
          ...
          <div className='relative'> 
            <Sparkles fill='transparent' className='h-8  w-8 text-primary animate-glow-pluse'/>

            <div className='absolute inset-0 h-8 w-8 text-secondary animate-glow-pluse opacity-50'/>
          </div>
